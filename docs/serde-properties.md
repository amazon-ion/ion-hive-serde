...
as `00:00`), see [timestamp](http://amazon-ion.github.io/ion-docs/docs/spec.html#timestamp) specification
for more details.
...
[shared symbol tables](http://amazon-ion.github.io/ion-docs/docs/symbols.html#shared-symbol-tables).
