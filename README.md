...
[![Build Status](https://github.com/amazon-ion/ion-hive-serde/actions/workflows/main.yml/badge.svg?branch=hive3)](https://github.com/amazon-ion/ion-hive-serde/actions?query=branch%3Ahive2+)
...
### Installation
Download the latest `ion-hive3-serde-all-<version-number>.jar` from [https://github.com/amazon-ion/ion-hive-serde/releases]
