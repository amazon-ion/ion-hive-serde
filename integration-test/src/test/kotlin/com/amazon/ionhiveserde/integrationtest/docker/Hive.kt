...
class Hive : Closeable {
    ...
    private fun serDeStatement(
            ...
            inputFormatClass: KClass<*> = com.amazon.ionhiveserde.formats.IonInputFormat::class): String {
        ...
        return """
            ROW FORMAT SERDE '${com.amazon.ionhiveserde.IonHiveSerDe::class.java.name}'
            $serdeProperties
            STORED AS
                INPUTFORMAT '${inputFormatClass.java.name}'
                OUTPUTFORMAT '${com.amazon.ionhiveserde.formats.IonOutputFormat::class.java.name}'
        """
    }
}
